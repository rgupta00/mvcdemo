package com.bookapp.web.interceptor;
...
public class DemoHandlerInterceptorAdapter extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request,
		...
		if (dayOfWeek == 7) { // 1 means Sunday, 2 means Monday....7 means
								// Saturday
